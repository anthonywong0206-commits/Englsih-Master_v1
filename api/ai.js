...
Return JSON with exactly these keys:
{
  ...
  if (task === 'roleplay') {
    return `You are running a live English role-play speaking practice.${noRepeat}
...
Use Traditional Chinese for explanations. Keep it encouraging and practical.`
  ...
  if (task === 'dictionary') {
    return `Analyze this English word for learners: ${payload?.word || 'environment'}.${noRepeat}
Return JSON with exactly these keys:
{
  "word":"",
  "phonetic":"",
  ...
  if (task === 'reading') {
    ...
    return `Generate an English reading lesson.${noRepeat}
